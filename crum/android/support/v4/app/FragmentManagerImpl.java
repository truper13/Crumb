    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER /*1*/:
                return makeOpenCloseAnimation(this.mActivity, 1.125f, GalleryViewer.PROGRESS_COMPLETED, 0.0f, GalleryViewer.PROGRESS_COMPLETED);
            case ANIM_STYLE_OPEN_EXIT /*2*/:
                return makeOpenCloseAnimation(this.mActivity, GalleryViewer.PROGRESS_COMPLETED, 0.975f, GalleryViewer.PROGRESS_COMPLETED, 0.0f);
            case ANIM_STYLE_CLOSE_ENTER /*3*/:
                return makeOpenCloseAnimation(this.mActivity, 0.975f, GalleryViewer.PROGRESS_COMPLETED, 0.0f, GalleryViewer.PROGRESS_COMPLETED);
            case ANIM_STYLE_CLOSE_EXIT /*4*/:
                return makeOpenCloseAnimation(this.mActivity, GalleryViewer.PROGRESS_COMPLETED, 1.075f, GalleryViewer.PROGRESS_COMPLETED, 0.0f);
            case ANIM_STYLE_FADE_ENTER /*5*/:
                return makeFadeAnimation(this.mActivity, 0.0f, GalleryViewer.PROGRESS_COMPLETED);
            case ANIM_STYLE_FADE_EXIT /*6*/:
                return makeFadeAnimation(this.mActivity, GalleryViewer.PROGRESS_COMPLETED, 0.0f);
            default:
